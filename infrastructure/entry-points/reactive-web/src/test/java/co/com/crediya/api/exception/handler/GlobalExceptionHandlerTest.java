...
class GlobalExceptionHandlerTest {
    ...
    @Test
    void handleCrediyaExceptionShouldReturnCustomStatus() {
        ServerWebExchange exchange = MockServerWebExchange.from(MockServerHttpRequest.get("/loans").build());

        CrediyaException exception = new CrediyaException( ExceptionStatusCode.BAD_REQUEST, "Custom Error", HttpStatus.BAD_REQUEST.value());
